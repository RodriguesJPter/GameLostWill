...
public class NpcMoon extends Entidade {
	...
	public void imagem(Graphics g) {
		g.drawImage(Entidade.aparenciaMoon , 270, 70, jframe);
	}
	...
	public void dialogoDois(Graphics g) {
		 ...
		 switch (Game.dialogo.linhaDialogo) {
	        case 0:
	        	Game.dialogo.textoUm = " olha so o que temos aqui";
	        	Game.inventario.inventarioAberto = false;
	        	break;
	        case 1:
	        	Game.dialogo.textoUm = "um cavaleiro perdido?";
	        	Game.inventario.inventarioAberto = false;
	        	break;
	        case 2:
	        	Game.dialogo.textoUm = "de que ordem voce faz parte?";
	        	Game.inventario.inventarioAberto = false;
	        	break;
	        case 3:
	        	Game.dialogo.textoUm = "bem nao importa na real";
	        	Game.inventario.inventarioAberto = false;
	        	break;
	        case 4:
	        	Game.dialogo.textoUm = "a guerra acabou... mas nao pra mim ";
	        	Game.inventario.inventarioAberto = false;
	        	break;
	        case 5:
	        	Game.dialogo.textoUm = "eu ainda tenho uma missao nesse reino";
	        	Game.inventario.inventarioAberto = false;
	        	break;
	        case 6:
	        	Game.dialogo.textoUm = "ah... mas eu vou dar o meu melhor!";
	        	Game.inventario.inventarioAberto = false;
	...
	public void dialogoDoisOpcaoUm(Graphics g) {
       ...
       g.drawImage(Entidade.escolhaDeFala , x, y + 34, jframe);;
	    g.setColor(Color.BLACK);
       g.setFont(new Font("Arial", Font.PLAIN, 12));
       g.drawString("que missao e essa?", x + 15, y + 53);
	...
	public void dialogoTres(Graphics g) {
		 ...
		 switch (Game.dialogo.linhaDialogo) {
	        case 0:
	        	Game.dialogo.textoUm = " OWN que voz fofa";
	        	Game.inventario.inventarioAberto = false;
	        	break;
	        case 1:
	        	Game.dialogo.textoUm = "mas parece que voce acabou de recussitar";
	        	Game.inventario.inventarioAberto = false;
	        	break;
	        case 2:
	        	Game.dialogo.textoUm = "bem eu sou uma guerreira do sul";
	        	Game.inventario.inventarioAberto = false;
	        	break;
	        case 3:
	        	Game.dialogo.textoUm = "e chamo Moon ";
	        	Game.inventario.inventarioAberto = false;
	        	break;
	        case 4:
	        	Game.dialogo.textoUm = "eu sei eu sei";
	        	Game.inventario.inventarioAberto = false;
	        	break;
	        case 5:
	        	Game.dialogo.textoUm = "eu sou linda, como pode";
	        	Game.inventario.inventarioAberto = false;
	        	break;
	        case 6:
		 ...
		 public void dialogoQuatro(Graphics g) {
			 ...
			 switch (Game.dialogo.linhaDialogo) {
		        case 0:
		        	Game.dialogo.textoUm = " olha so que fofo voce tentando falar";
		        	Game.inventario.inventarioAberto = false;
		        	break;
		        case 1:
		        	Game.dialogo.textoUm = "mas por que voce quer saber ?!";
		        	Game.inventario.inventarioAberto = false;
		        	break;
		        case 2:
		        	Game.dialogo.textoUm = "esse gatao ficou interassado em mim";
		        	Game.inventario.inventarioAberto = false;
		        	break;
		        case 3:
		        	Game.dialogo.textoUm = "mas acho que se eu falar pra voce";
		        	Game.inventario.inventarioAberto = false;
		        	break;
		        case 4:
		        	Game.dialogo.textoUm = "nao vai ter problema";
		        	Game.inventario.inventarioAberto = false;
		        	break;
		        case 5:
		        	Game.dialogo.textoUm = "eu vou cacar o filho do medo";
		        	Game.inventario.inventarioAberto = false;
		        	break;
		        case 6:
		        	Game.dialogo.textoUm = "";
			 ...
			 public void dialogoSeis(Graphics g) {
				 ...
				 switch (Game.dialogo.linhaDialogo) {
			        case 0:
			        	Game.dialogo.textoUm = " ah, esqueci de te avizar";
			        	Game.inventario.inventarioAberto = false;
			        	break;
			        case 1:
			        	Game.dialogo.textoUm = "caso voce queira seguir em frente";
			        	Game.inventario.inventarioAberto = false;
			        	break;
			        case 2:
			        	Game.dialogo.textoUm = "vai ter que pegar a chave com o ";
			        	Game.inventario.inventarioAberto = false;
			        	break;
			        case 3:
			        	Game.dialogo.textoUm = " babaca daquele cachorro";
			        	Game.inventario.inventarioAberto = false;
			        	break;
			        case 4:
			        	Game.dialogo.textoUm = "aquele cachorro magro infernal";
			        	Game.inventario.inventarioAberto = false;
			        	break;
			        case 5:
			        	Game.dialogo.textoUm = "e so seguir ao leste";
			        	Game.inventario.inventarioAberto = false;
			        	break;
			        case 6:
			        	Game.dialogo.textoUm = "";
