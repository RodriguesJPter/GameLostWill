...
public class PortaMadeira extends Entidade {
    ...
    public PortaMadeira(int x, int y, int width, int height, BufferedImage chao) {
...
//      System.out.println("Distância até o jogador: " + distancia);
			...
			if(jogadorProximo) {
				if(Game.player.interagindoComPorta == true) {
					System.out.println("inderagiu com a porta numero 1");
					controlePorta();
		 ...
		 if (Game.mapaAtual == Game.mapaContador.mapa07) {
				...
				if(Game.level > Game.levelMaximo) {
				 ...
				 if (Game.mapaAtual == Game.mapaContador.mapa06 && Game.mapaAnterior == Game.mapaContador.mapa03 ||
					...
					Level = "casa1.png";
					Game.mapaAtual = Game.mapaContador.casa01;
					Mundo.levelAtual = 1;
