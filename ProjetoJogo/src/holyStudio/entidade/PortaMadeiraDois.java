...
public class PortaMadeiraDois extends Entidade {
    ...
    public PortaMadeiraDois(int x, int y, int width, int height, BufferedImage chao) {
        ...
        frameDelay++;
			...
			if(jogadorProximo) {
				...
				if(Game.player.interagindoComPorta == true) {
					System.out.println("inderagiu com a porta numero 2");
					controlePorta();
		 ...
		 if (Game.mapaAtual == Game.mapaContador.mapa07) {
				...
				if(Game.level > Game.levelMaximo) {
				 ...
				 if (Game.mapaAtual == Game.mapaContador.mapa06 && Game.mapaAnterior == Game.mapaContador.mapa03 ||
					...
					Level = "casa2.png";
					Game.mapaAtual = Game.mapaContador.casa02;
					Mundo.levelAtual = 1;
